...
interface PlaceDetailRemoteSource {
    suspend fun getPlaceDetailList(placeID: String): PlaceInfoDTO
}

class PlaceDetailRemoteSourceImpl(
    private val dispatcherProvider: DispatcherProvider
) : PlaceDetailRemoteSource {
    override suspend fun getPlaceDetailList(placeID: String): PlaceInfoDTO = withContext(dispatcherProvider.getIO()){
        ...
        PlaceInfoDTO(
            ...
            reviews = 3214,
            description = "A verdant oasis in the heart of New York City, offering serene landscapes and outdoor activities.",
            facilities = listOf("Restrooms", "Bike Rentals", "Food Stands", "Playgrounds"),
            price = 300.toDouble(),
            latitude = 40.785091,
            longitude = -73.968285
        )
